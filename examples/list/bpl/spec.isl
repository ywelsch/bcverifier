...
local invariant bijective(bij) && related(bij, null, null) && x1 == null && x2 == null;
...
local invariant at(q1) && at(q2) ==> related(bij, eval(q1, n), eval(q2, n)) && eval(q1, c) == eval(q2, c) && eval(q1, i) == eval(q2, i) && eval(q1, n) != null && eval(q2, n) != null;
local invariant at(q1) && at(q2) && related(bij, eval(q1, n), eval(q2, n)) ==> related(bij, eval(q1, n.next), eval(q2, n.next));
...
local place qn1 = line 37 of old Observable stall when stackIndex(new) > 1 with measure stackIndex(new);
local place qn2 = line 23 of new Node when stackIndex(new) > 0 && at(pcall, 0);
local invariant at(pn1) && at(pn2) ==> related(bij, eval(pn1, n), eval(pn2, this)) && eval(pn1, n) != null && eval(pn2, this) != null;
local invariant at(pn1) && at(pn2) ==> related(bij, eval(pn1, n.next), eval(pn2, this.next));
local invariant at(pn1) && at(pn2) ==> (eval(pn1, n.next) == null <==> eval(pn2, this.next) == null) && eval(pn1, n.ob) != null && eval(pn2, this.ob) != null && eval(pn1, n.ob) ~ eval(pn2, this.ob);
// Place only added to help the verifier deduce additional facts
...
local invariant at(pe1) && at(pe2) ==> related(bij, eval(pe1, n), eval(pe2, this)) && eval(pe1, n) != null && eval(pe2, this) != null;
local invariant at(pe1) && at(pe2) ==> related(bij, eval(pe1, n.next), eval(pe2, this.next));
local invariant at(pe1) && at(pe2) ==> (eval(pe1, n.next) == null <==> eval(pe2, this.next) == null);