...
invariant forall old MyIter i1, new ObsIter i2 :: i1 ~ i2 ==>
     i1.o ~ i2.o;
//invariant forall old MyIter i1, new ObsIter i2 :: i1 ~ i2 ==>
//	i1.n != i1.o.fst && i2.n == i2.o.snt ==> i1.expectedModCount != i1.o.modCount;
invariant forall old MyIter i1, new ObsIter i2 :: i1 ~ i2
	&& i1.expectedModCount == i1.o.modCount 
	==> (i1.o.fst == i1.n <==> i2.o.snt == i2.n);
invariant forall old MyIter i1, new ObsIter i2 :: i1 ~ i2 
  && i1.expectedModCount == i1.o.modCount  
   ==> related(bij, i1.n, i2.n.next);
...
local invariant at(pe1) && at(pe2) ==>
 ...
 local invariant at(hasNext1) && at(hasNext2) ==> 
   (eval(hasNext1, this.n == null) <==> eval(hasNext2, this.n.next == null)); 
