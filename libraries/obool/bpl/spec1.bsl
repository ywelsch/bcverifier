...
(forall iframe: int :: 0<=iframe && iframe<=ip1 && iframe % 2 == 1 ==> ((stack1[iframe][spmap1[iframe]][place] == lib1_obool.OBool.getg#boolean_get#boolean0) ==> (!heap1[stack1[iframe+1][spmap1[iframe+1]][param0_r], createdByCtxt])))
<<<