...
local place newPN = line 9 of new C when stackIndex(new) == 1 && at(newN, 0) && i == 0 splitvc;
local place newPM = line 9 of new C when stackIndex(new) == 1 && at(newM, 0) && i == 1 splitvc;
