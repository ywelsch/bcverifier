...
(forall iframe: int :: 0<=iframe && iframe<=ip1 && iframe % 2 == 1 ==> (stack1[iframe][spmap1[iframe]][place] == lib1_C.m_set$int$java.lang.Object_0) ==> (stack1[iframe][spmap1[iframe]][reg1_i] == stack2[iframe][spmap2[iframe]][param1_i]))
...
(forall iframe: int :: 0<=iframe && iframe<=ip1 && iframe % 2 == 1 ==> (stack1[iframe][spmap1[iframe]][place] == lib1_C.m_set$int$java.lang.Object_0) ==> (stack1[iframe][spmap1[iframe]][param0_r] == stack1[iframe][0][param0_r] && stack2[iframe][spmap2[iframe]][param0_r] == stack2[iframe][0][param0_r]))
