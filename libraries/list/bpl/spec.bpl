...
(exists relint: Bij :: Bijective(relint) && ObjectCoupling(heap1, heap2, relint) && (forall o1, o2: Ref :: Obj(heap1, o1) && Obj(heap2, o2) && related[o1,o2] && RefOfType(o1, heap1, $list.List) && RefOfType(o2, heap2, $list.List) ==> RelNull(heap1[o1,$list.List.fst],heap2[heap2[o2, $list.List.snt], $list.Node.next], relint)) && (forall o1, o2: Ref :: Obj(heap1, o1) && Obj(heap2, o2) && relint[o1, o2] ==> RelNull(heap1[o1, $list.Node.ob],heap2[o2, $list.Node.ob],related) ))
