...
(stack1[ip1][spmap1[ip1]][place] == inLoop1) ==> (stack1[ip1][spmap1[ip1]][reg1_i] == stack2[ip2][spmap2[ip2]][reg1_i]) //the value of the parameter is the same
...
<<<
>>>places
inLoop1 = old 7 (stack1[ip1][spmap1[ip1]][reg3_i] > 0)
inLoop2 = new 8 (stack2[ip2][spmap2[ip2]][reg3_i] > 0)
<<<