...
stack1[ip1][spmap1[ip1]][place] == oldInLoop ==> (stack1[ip1][spmap1[ip1]][reg2_i] == stack1[ip2][spmap2[ip2]][reg3_i])     //the value of x is the value of i (before adding)
stack1[ip1][spmap1[ip1]][place] == oldInLoop ==> (stack1[ip1][spmap1[ip1]][reg3_i] < stack1[ip2][spmap2[ip2]][reg1_i])      //i runs until n
