...
oldInLoop = old 5 (true) (stack1[ip1][spmap1[ip1]][param1_i] - stack1[ip1][spmap1[ip1]][reg3_i])
...
stack1[ip1][spmap1[ip1]][place] == oldInLoop ==> (stack1[ip1][spmap1[ip1]][param1_i] == stack2[ip2][spmap2[ip2]][param1_i])     //n on both sides is the same
...
stack1[ip1][spmap1[ip1]][place] == oldInLoop ==> (stack1[ip1][spmap1[ip1]][reg3_i] < stack1[ip1][spmap1[ip1]][param1_i])      //i runs until n
stack1[ip1][spmap1[ip1]][place] == oldInLoop ==> (stack1[ip1][spmap1[ip1]][reg3_i] >= 0)                       //i starts at 0
stack2[ip2][spmap2[ip2]][place] == newBeforeReturn ==> (if(stack2[ip2][spmap2[ip2]][param1_i] >= 0) then (stack2[ip2][spmap2[ip2]][reg2_i] == stack2[ip2][spmap2[ip2]][param1_i]) else (stack2[ip2][spmap2[ip2]][reg2_i] == 0))
<<<