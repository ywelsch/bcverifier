define('ace/mode/boogie', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/javascript', 'ace/tokenizer', 'ace/mode/boogie_highlight_rules'], function(require, exports, module) {


var oop = require("../lib/oop");
var JavaScriptMode = require("./javascript").Mode;
var Tokenizer = require("../tokenizer").Tokenizer;
var BoogieHighlightRules = require("./boogie_highlight_rules").BoogieHighlightRules;
...
define('ace/mode/boogie_highlight_rules', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function(require, exports, module) {
...
var BoogieHighlightRules = function() {
    ...
    var keywords = lang.arrayToMap(
        (
            "assert|assume|axiom|break|call|complete|const|else|ensures|exists|forall|finite|free|" +
            "function|goto|havoc|if|implementation|invariant|modifies|old|procedure|requires|return|" +
            "returns|then|type|unique|var|where|while"
        ).split("|")
    );
